...
const Featured = () => {
  return (
    <div className="container mt-20 mb-4 md:ml-65 px-2">
      ...
      <div className="items-center justify-center hidden md:flex">
        <Carousel orientation="horizontal" className="w-full max-w-5xl h-120">
          <CarouselContent>
      ...
      <div className="flex items-center justify-center md:hidden">
        <Carousel className="w-full max-w-xs h-100" orientation="horizontal">
          <CarouselContent>
            {featuredItems.map((item, index) => (
              <CarouselItem key={index}>
                <div>
